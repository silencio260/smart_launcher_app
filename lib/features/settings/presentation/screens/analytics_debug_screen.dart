...
const List<_EventGroup> _eventCatalog = [
  ...
  _EventGroup('Retention (from RetentionTracker)', [
    ...
    _EventDef('retention_session_started', ['engagement metrics']),
    _EventDef('retention_first_open'),
    _EventDef('retention_second_open'),
    _EventDef('retention_third_open'),
    _EventDef('retention_fourth_open'),
    _EventDef('retention_fifth_open'),
    _EventDef('retention_first_session'),
    _EventDef('retention_second_session'),
    ...
    _EventDef('retention_day_10_returned'),
    _EventDef('retention_day_15_returned'),
    _EventDef('retention_day_20_returned'),
    _EventDef('retention_day_25_returned'),
    _EventDef('retention_day_30_returned'),
  ]),
];
