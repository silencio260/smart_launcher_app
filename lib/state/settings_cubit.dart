...
class SettingsCubit extends Cubit<LauncherSettings> {
  ...
  LauncherSettings _fromJson(Map<String, dynamic> j) {
    ...
    return LauncherSettings(
      ...
      notificationBadgesEnabled: j['notificationBadgesEnabled'] as bool? ?? true,
      ...
      wallpaperBlurIntensity: (j['wallpaperBlurIntensity'] as num?)?.toDouble() ?? 0.3,
      ...
      dockBackgroundColor: j['dockBackgroundColor'] != null
          ...
          : Colors.black,
      dockBackgroundOpacity: (j['dockBackgroundOpacity'] as num?)?.toDouble() ?? 0.4,
      ...
      folderColor: j['folderColor'] != null ? Color(j['folderColor'] as int) : Colors.black54,
